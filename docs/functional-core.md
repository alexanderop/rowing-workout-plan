...
| ------------------ | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| **Core**           | Pure decisions over values                           | `db/converters.ts`, `features/*/{catalog,domain,pace,progress,schedule,session,targets,types}.ts`, `lib/installPlatform.ts`, `lib/utils.ts`                            | Deterministic; no complexity cap                      |
