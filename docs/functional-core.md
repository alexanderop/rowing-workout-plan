...
| ------------------ | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| **Core**           | Pure decisions over values                           | `db/converters.ts`, `features/*/{catalog,domain,pace,schedule,targets,types}.ts`, `lib/installPlatform.ts`, `lib/utils.ts`                                             | Deterministic; no complexity cap                      |
