...
| ------------------ | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| **Core**           | Pure decisions over values                           | `db/converters.ts`, `features/*/{catalog,domain,history,pace,progress,schedule,session,targets,types,week}.ts`, `lib/installPlatform.ts`, `lib/utils.ts`               | Deterministic; no complexity cap                      |
